...
Shader2D::Shader2D(const string FileLocation, Camera& camera)
{
	m_Camera = &camera;
	Name = FileLocation;
...
void Shader2D::Update(Transform& transform, std::vector<LightBase*>Lights, mat4 lightSpaceMatrix)
{
...
void Shader2D::UpdateForShadows(Transform& transform, glm::mat4& LightSpaceMatrix)
{
...
GLuint Shader2D::getProgram()
{
	return m_Program;
}

lightStruct* Shader2D::convertLightArrayToStruct(std::vector<LightBase*>Lights)
{
